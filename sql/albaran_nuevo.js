/* ===== Albaran de servicio v2 - encargo de Jennifer del 21/09/2026 =====
   - Se elige el cliente de verdad: buscador encima del desplegable y sin
     preseleccionar a nadie.
   - La obra se elige de las que tiene el cliente, y se puede crear alli mismo.
   - Dos tipos de albaran que se facturan: el DeCA de un traslado y las horas
     de trabajo de un empleado.
   - Un mismo viaje puede llevar varias paradas: recogidas, entregas y paradas.
   - Firman el cliente y el conductor.
*/
MDX.nalb=function(){
